// ==UserScript==
// @name         ANT To Radarr Mod
// @version      1.0.0
// @author       Audionut - Original PTP Mod by Prism16 - Main Script by DirtyCajunRice / CatSpinner
...
async function buttonBuilder(movie, href, type, theme) {
    ...
    if (type == "single") {
        ...
        let titleLinkElement = movie.querySelector(".title-link");

        if (titleLinkElement) {
            titleLinkElement.appendChild(button);
        } else {
