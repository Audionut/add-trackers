...
// @downloadURL  https://github.com/Audionut/add-trackers/raw/tvdbid-test/ptp-add-filter-all-releases-anut.js
// @updateURL    https://github.com/Audionut/add-trackers/raw/tvdbid-test/ptp-add-filter-all-releases-anut.js
...
// @require      https://github.com/Audionut/add-trackers/raw/tvdbid-test/ptp-get-tmdb-id.js
// ==/UserScript==
...
(function () {
    ...
    const fields = {
        ...
        "btnsearchmethod": {"label": "BTN search method", "type": "select", "options": ["TVDB ID", "Search"], "default": "TVDB ID", "tooltip": "Choose the BTN API search parameter. TVDB ID is accurate, but only works for shows. Search will find related movies and do weird stuff."},
        ...
        const post_json = async (post_query_url, tracker, postData, timeout = timer) => {
            ...
            try {
                ...
                if (response.status === 200) {
                    console.log(`raw from ${tracker}`, response.responseText);
        ...
        const mainFunc = async () => {
            ...
            if (btnSearchMethod === "TVDB ID") {
                ...
                function getTvdbId() {
                    ...
                    if (!tvdbId) {
                        tvdbId = getTvdbIdFromStorage(ptpId);
                    }
                    return tvdbId;
                }
            }
