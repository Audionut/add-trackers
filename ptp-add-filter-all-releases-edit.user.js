...
// @author       passthepopcorn_cc (edited by Perilune)
...
(function () {
    ...
    //  available trackers: "BHD", "CG", "FL", "HDB", "KG", "PTP", "BLU"*, "TIK"*, "Aither"*, "RFX"*, "OE"*, "AvistaZ"**, "CinemaZ"**, "PHD"**
    ...
    const trackers = ["BHD", "CG", "FL", "HDB", "KG", "PTP"];
    ...
    const show_tracker_name = false; // false = will hide tracker name ||| true = will show tracker name
    const hide_if_torrent_with_same_size_exists = true;  // true = will hide torrents with the same file size as existing PTP ones
    const log_torrents_with_same_size = true;  // true = will log torrents with the same file size as existing PTP ones in console (F12)
